...
model;
    ...
    1 - beta * R_1 = (psi / c^(-sigma)) * alpha_k1 * alpha_ik_1 * L^(1/eta - gamma) * L_k1^(1/rho_k1 - 1/eta) * b_1^(-1/rho_k1);
    b_2 = b_bar_2 + phi_2 * omega_G_2;
    1 - beta * R_2 = (psi / c^(-sigma)) * alpha_k1 * alpha_ik_2 * L^(1/eta - gamma) * L_k1^(1/rho_k1 - 1/eta) * b_2^(-1/rho_k1);
    b_3 = b_bar_3 + phi_3 * omega_G_3;
    1 - beta * R_3 = (psi / c^(-sigma)) * alpha_k1 * alpha_ik_3 * L^(1/eta - gamma) * L_k1^(1/rho_k1 - 1/eta) * b_3^(-1/rho_k1);
    b_4 = b_bar_4 + phi_4 * omega_G_4;
    1 - beta * R_4 = (psi / c^(-sigma)) * alpha_k2 * alpha_ik_4 * L^(1/eta - gamma) * L_k2^(1/rho_k2 - 1/eta) * b_4^(-1/rho_k2);
    b_5 = b_bar_5 + phi_5 * omega_G_5;
    1 - beta * R_5 = (psi / c^(-sigma)) * alpha_k2 * alpha_ik_5 * L^(1/eta - gamma) * L_k2^(1/rho_k2 - 1/eta) * b_5^(-1/rho_k2);
    b_6 = b_bar_6 + phi_6 * omega_G_6;
    1 - beta * R_6 = (psi / c^(-sigma)) * alpha_k3 * alpha_ik_6 * L^(1/eta - gamma) * L_k3^(1/rho_k3 - 1/eta) * b_6^(-1/rho_k3);
    b_7 = b_bar_7 + phi_7 * omega_G_7;
    1 - beta * R_7 = (psi / c^(-sigma)) * alpha_k3 * alpha_ik_7 * L^(1/eta - gamma) * L_k3^(1/rho_k3 - 1/eta) * b_7^(-1/rho_k3);
end;
