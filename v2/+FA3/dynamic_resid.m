...
residual = zeros(39, 1);
    ...
    residual(15) = (exp(y(15))) - (T(3)*T(4));
    residual(16) = (exp(y(22))) - (1+params(9)*T(6));
    ...
    residual(22) = (exp(y(14))) - (exp(y(19))+exp(y(20))+exp(y(21))+T(9));
    residual(23) = (exp(y(15))) - (exp(y(14))*exp(y(40)));
    residual(24) = (exp(y(40))) - (T(12)+(1-params(11))*T(15)^((-params(10))/(1-params(11))));
    residual(25) = (exp(y(39))) - (1/exp(y(35)));
    residual(26) = (exp(y(41))) - (exp(y(35))*exp(y(14))+T(18));
    residual(27) = (exp(y(42))) - (exp(y(14))+T(21));
    residual(28) = (exp(y(52))) - (T(22));
    ...
    residual(31) = (exp(y(43))) - (T(23)*T(28)*exp(x(it_, 5)));
