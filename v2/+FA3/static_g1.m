...
if T_flag
    T = FA3.static_g1_tt(T, y, x, params);
end
g1 = zeros(39, 39);
g1(1,7)=(-(T(35)-params(3)*params(1)*T(35)));
g1(1,10)=exp(y(10));
...
g1(14,9)=(-((exp(y(9))*exp(y(9))*exp(y(36))-exp(y(9))*T(3))/(exp(y(9))*exp(y(9)))));
g1(14,12)=exp(y(12));
g1(14,22)=T(31);
...
g1(15,2)=exp(y(2));
g1(15,3)=T(32);
g1(15,5)=(-(T(4)*exp(y(5))*getPowerDeriv(exp(y(5)),1-params(7),1)));
g1(15,25)=T(32);
g1(15,35)=(-(T(4)*T(5)));
g1(15,36)=T(32);
g1(16,3)=(-(params(9)*T(33)));
g1(16,6)=(-(params(9)*T(6)));
g1(16,9)=exp(y(9));
...
g1(22,1)=exp(y(1));
g1(22,3)=(-(T(10)+exp(y(3))*params(9)/2*T(33)*2*T(7)));
g1(22,6)=(-(exp(y(6))+exp(y(3))*params(9)/2*T(6)*2*T(7)));
g1(22,7)=(-exp(y(7)));
g1(22,8)=(-exp(y(8)));
g1(23,1)=(-(exp(y(1))*exp(y(27))));
g1(23,2)=exp(y(2));
g1(23,27)=(-(exp(y(1))*exp(y(27))));
g1(24,27)=exp(y(27))-T(14);
g1(24,38)=(-(T(13)*exp(y(27))*params(11)*T(11)*getPowerDeriv(T(11),(-params(12))*params(10),1)+T(12)*T(37)+(1-params(11))*(-(T(16)*params(11)*T(11)*getPowerDeriv(T(11),params(12)*(1-params(11)),1)+T(15)*T(11)*getPowerDeriv(T(11),params(11)-1,1)))/(1-params(11))*getPowerDeriv((1-T(15)*T(16))/(1-params(11)),(-params(10))/(1-params(11)),1)));
g1(25,22)=(-((-exp(y(22)))/(exp(y(22))*exp(y(22)))));
g1(25,26)=exp(y(26));
g1(26,1)=(-(exp(y(22))*exp(y(1))));
g1(26,11)=(-T(18));
g1(26,22)=(-(exp(y(22))*exp(y(1))));
g1(26,28)=exp(y(28))-T(18);
g1(26,38)=(-(exp(y(28))*(T(17)*exp(y(11))*params(1)*params(11)*T(37)+T(13)*exp(y(11))*params(1)*params(11)*T(11)*getPowerDeriv(T(11),params(12)*(-params(10)),1))));
g1(27,1)=(-exp(y(1)));
g1(27,11)=(-T(21));
g1(27,29)=exp(y(29))-T(21);
g1(27,38)=(-(exp(y(29))*(T(20)*exp(y(11))*params(1)*params(11)*T(11)*getPowerDeriv(T(11),params(10)-1,1)+T(19)*T(38))));
g1(28,28)=(-T(22));
g1(28,29)=(-(T(11)*(-(exp(y(29))*exp(y(28))*params(10)/(params(10)-1)))/(exp(y(29))*exp(y(29)))));
g1(28,38)=(-T(22));
g1(28,39)=exp(y(39));
g1(29,38)=T(11)*getPowerDeriv(T(11),1-params(10),1)-params(11)*T(38);
g1(29,39)=(-((1-params(11))*exp(y(39))*getPowerDeriv(exp(y(39)),1-params(10),1)));
g1(30,13)=(-(exp(y(13))*T(11)));
g1(30,30)=exp(y(30));
g1(30,38)=(-(exp(y(13))*T(11)));
g1(31,26)=(-(exp(x(5))*T(23)*T(24)*T(25)*getPowerDeriv(T(25),params(14),1)*T(36)));
g1(31,30)=exp(y(30))-exp(x(5))*T(28)*exp(y(30))*getPowerDeriv(exp(y(30)),params(15),1);
g1(31,38)=(-(exp(x(5))*T(23)*T(36)*T(26)*1/params(1)*T(11)*getPowerDeriv(T(11),params(13),1)));
