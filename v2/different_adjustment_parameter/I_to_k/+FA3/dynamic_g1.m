...
g1 = zeros(39, 68);
g1(1,2)=(-((-(params(3)*exp(y(2))))*T(34)));
g1(1,20)=(-(exp(y(20))*T(34)-params(3)*params(1)*(-(exp(y(20))*params(3)))*T(35)));
g1(1,53)=params(3)*params(1)*exp(y(53))*T(35);
g1(1,23)=exp(y(23));
...
g1(15,15)=exp(y(15));
g1(15,1)=T(31);
g1(15,18)=(-(T(28)*exp(y(18))*getPowerDeriv(exp(y(18)),1-params(7),1)));
g1(15,48)=(-(T(3)*T(28)));
g1(15,49)=T(31);
g1(16,1)=(-(params(9)*T(32)));
g1(16,19)=(-(params(9)*T(4)));
g1(16,22)=exp(y(22));
g1(17,45)=exp(y(45));
g1(18,38)=1;
...
g1(22,14)=exp(y(14));
g1(22,1)=(-(T(7)+exp(y(1))*params(9)/2*T(32)*2*T(5)));
g1(22,19)=(-(exp(y(19))+exp(y(1))*params(9)/2*T(4)*2*T(5)));
g1(22,20)=(-exp(y(20)));
g1(22,21)=(-exp(y(21)));
...
g1(24,8)=(-T(10));
g1(24,40)=exp(y(40));
g1(24,13)=(-(T(9)*params(11)*exp(y(8))*exp(y(13))*getPowerDeriv(exp(y(13)),(-params(12))*params(10),1)+(1-params(11))*(-(T(12)*params(11)*exp(y(13))*getPowerDeriv(exp(y(13)),params(12)*(1-params(11)),1)))/(1-params(11))*T(37)));
g1(24,51)=(-(T(8)*exp(y(51))*getPowerDeriv(exp(y(51)),params(10),1)+(1-params(11))*T(37)*(-(T(11)*exp(y(51))*getPowerDeriv(exp(y(51)),params(11)-1,1)))/(1-params(11))));
...
g1(26,41)=exp(y(41));
g1(26,60)=(-T(16));
g1(26,51)=(-(exp(y(60))*T(14)*exp(y(51))*getPowerDeriv(exp(y(51)),params(12)*(-params(10)),1)));
g1(26,63)=(-(exp(y(60))*T(15)*exp(y(54))*params(1)*params(11)*exp(y(63))*getPowerDeriv(exp(y(63)),params(10),1)));
g1(27,14)=(-exp(y(14)));
g1(27,54)=(-T(19));
g1(27,42)=exp(y(42));
g1(27,61)=(-T(19));
g1(27,51)=(-(exp(y(61))*T(17)*exp(y(51))*getPowerDeriv(exp(y(51)),params(12)*(1-params(10)),1)));
g1(27,63)=(-(exp(y(61))*T(18)*exp(y(54))*params(1)*params(11)*exp(y(63))*getPowerDeriv(exp(y(63)),params(10)-1,1)));
g1(28,41)=(-T(20));
...
g1(31,39)=(-(exp(x(it_, 5))*T(21)*T(22)*T(23)*getPowerDeriv(T(23),params(14),1)*T(36)));
g1(31,9)=(-(exp(x(it_, 5))*T(26)*exp(y(9))*getPowerDeriv(exp(y(9)),params(15),1)));
g1(31,43)=exp(y(43));
g1(31,51)=(-(exp(x(it_, 5))*T(21)*T(36)*T(24)*1/params(1)*exp(y(51))*getPowerDeriv(exp(y(51)),params(13),1)));
g1(31,68)=(-(T(21)*T(26)*exp(x(it_, 5))));
g1(32,10)=(-params(18));
g1(32,48)=1;
g1(32,64)=1;
g1(33,11)=(-params(16));
