...
residual = zeros(39, 1);
    ...
    residual(4) = (y(18)) - ((-1.09861229866811));
    residual(5) = (exp(y(30))) - (T(1));
    ...
    residual(14) = (exp(y(25))) - (T(2)/exp(y(3)));
    residual(15) = (exp(y(15))) - (T(3)*T(28));
    residual(16) = (exp(y(22))) - (1+params(9)*T(5));
    residual(17) = (exp(y(45))) - (params(32)+params(31)/(1+params(5)));
residual(18) = y(38);
    residual(19) = (y(46)) - (exp(y(19))-exp(y(1))*exp(y(49))*exp(y(45)));
    residual(20) = (exp(y(16))) - (y(46)+T(6));
    residual(21) = (exp(y(21))) - (params(33)*exp(y(50)));
    residual(22) = (exp(y(14))) - (exp(y(19))+exp(y(20))+exp(y(21))+T(7));
    residual(23) = (exp(y(15))) - (exp(y(14))*exp(y(40)));
    residual(24) = (exp(y(40))) - (T(10)+(1-params(11))*T(13)^((-params(10))/(1-params(11))));
    residual(25) = (exp(y(39))) - (1/exp(y(35)));
    residual(26) = (exp(y(41))) - (exp(y(35))*exp(y(14))+T(16));
    residual(27) = (exp(y(42))) - (exp(y(14))+T(19));
    residual(28) = (exp(y(52))) - (T(20));
