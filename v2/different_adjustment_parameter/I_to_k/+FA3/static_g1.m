...
g1 = zeros(39, 39);
g1(1,7)=(-(T(34)-params(3)*params(1)*T(34)));
g1(1,10)=exp(y(10));
...
g1(15,2)=exp(y(2));
g1(15,3)=T(31);
g1(15,5)=(-(T(6)*exp(y(5))*getPowerDeriv(exp(y(5)),1-params(7),1)));
g1(15,35)=(-(T(4)*T(6)));
g1(15,36)=T(31);
g1(16,3)=(-(params(9)*T(32)));
...
g1(22,1)=exp(y(1));
g1(22,3)=(-(T(9)+exp(y(3))*params(9)/2*T(32)*2*T(8)));
...
g1(24,27)=exp(y(27))-T(13);
g1(24,38)=(-(T(12)*exp(y(27))*params(11)*T(10)*getPowerDeriv(T(10),(-params(12))*params(10),1)+T(11)*T(36)+(1-params(11))*(-(T(15)*params(11)*T(10)*getPowerDeriv(T(10),params(12)*(1-params(11)),1)+T(14)*T(10)*getPowerDeriv(T(10),params(11)-1,1)))/(1-params(11))*getPowerDeriv((1-T(14)*T(15))/(1-params(11)),(-params(10))/(1-params(11)),1)));
g1(25,22)=(-((-exp(y(22)))/(exp(y(22))*exp(y(22)))));
g1(25,26)=exp(y(26));
g1(26,1)=(-(exp(y(22))*exp(y(1))));
g1(26,11)=(-T(17));
g1(26,22)=(-(exp(y(22))*exp(y(1))));
g1(26,28)=exp(y(28))-T(17);
g1(26,38)=(-(exp(y(28))*(T(16)*exp(y(11))*params(1)*params(11)*T(36)+T(12)*exp(y(11))*params(1)*params(11)*T(10)*getPowerDeriv(T(10),params(12)*(-params(10)),1))));
g1(27,1)=(-exp(y(1)));
g1(27,11)=(-T(20));
g1(27,29)=exp(y(29))-T(20);
g1(27,38)=(-(exp(y(29))*(T(19)*exp(y(11))*params(1)*params(11)*T(10)*getPowerDeriv(T(10),params(10)-1,1)+T(18)*T(37))));
g1(28,28)=(-T(21));
g1(28,29)=(-(T(10)*(-(exp(y(29))*exp(y(28))*params(10)/(params(10)-1)))/(exp(y(29))*exp(y(29)))));
g1(28,38)=(-T(21));
g1(28,39)=exp(y(39));
g1(29,38)=T(10)*getPowerDeriv(T(10),1-params(10),1)-params(11)*T(37);
g1(29,39)=(-((1-params(11))*exp(y(39))*getPowerDeriv(exp(y(39)),1-params(10),1)));
g1(30,13)=(-(exp(y(13))*T(10)));
g1(30,30)=exp(y(30));
g1(30,38)=(-(exp(y(13))*T(10)));
g1(31,26)=(-(exp(x(5))*T(22)*T(23)*T(24)*getPowerDeriv(T(24),params(14),1)*T(35)));
g1(31,30)=exp(y(30))-exp(x(5))*T(27)*exp(y(30))*getPowerDeriv(exp(y(30)),params(15),1);
g1(31,38)=(-(exp(x(5))*T(22)*T(35)*T(25)*1/params(1)*T(10)*getPowerDeriv(T(10),params(13),1)));
